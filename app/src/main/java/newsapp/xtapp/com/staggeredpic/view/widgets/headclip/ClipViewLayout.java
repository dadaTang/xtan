package newsapp.xtapp.com.staggeredpic.view.widgets.headclip;
...
import newsapp.xtapp.com.staggeredpic.util.LogUtil;

import static newsapp.xtapp.com.staggeredpic.util.FileUtils.getRealFilePathFromUri;
...
public class ClipViewLayout extends RelativeLayout {
    ...
    public void initSrcPic(Uri uri) {
        ...
        LogUtil.d("**********clip_view uri*******  " + uri);
        String path = getRealFilePathFromUri(getContext(), uri);
        LogUtil.d("**********clip_view path*******  " + path);
