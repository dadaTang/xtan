package newsapp.xtapp.com.staggeredpic.view;
...
public class QRCodeActivity extends BaseActivity {
    ...
    private void showShare() {
        ...
        oks.setTitleUrl("https://fir.im/xtan");
        // text是分享文本，所有平台都需要这个字段
        oks.setText("每日新闻，精选干货，最新资讯，应有尽有.下载链接：https://fir.im/xtan");
        // imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
        //oks.setImagePath("/sdcard/test.jpg");//确保SDcard下面存在此张图片
        // url仅在微信（包括好友和朋友圈）中使用
        //由于微信需要注册AppKey才能演示，这里取消微信分享，个人根据自己的需求注册Appkey使用
        oks.setUrl("https://fir.im/xtan");
