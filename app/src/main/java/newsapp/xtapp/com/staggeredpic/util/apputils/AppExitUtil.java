...
import newsapp.xtapp.com.staggeredpic.util.SnackBarUtils;
...
public class AppExitUtil {
    ...
    public static boolean exitApp(Context context, View view) {
        ...
        LogUtil.i( isExit + "");
        LogUtil.i( "最大内存：" + Runtime.getRuntime().maxMemory());
        LogUtil.i( "占用内存：" + Runtime.getRuntime().totalMemory());
        LogUtil.i( "空闲内存：" + Runtime.getRuntime().freeMemory());
        return isExit;
    }
