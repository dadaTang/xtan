...
import newsapp.xtapp.com.staggeredpic.adapter.MovieDetailAdapter;
import newsapp.xtapp.com.staggeredpic.base.BasePresenter.BasePresenter;
import newsapp.xtapp.com.staggeredpic.base.activity.BaseMVPActivity;
...
import newsapp.xtapp.com.staggeredpic.presenter.movie.MovieDetailPresenter;
...
import newsapp.xtapp.com.staggeredpic.widgets.CompatNestedScrollView;

import static newsapp.xtapp.com.staggeredpic.constant.InternKeyConstant.INTENT_KEY_MOVIE_SUBJECTBEAN;
import static newsapp.xtapp.com.staggeredpic.util.StatusBarUtils.getStatusBarHeight;
...
public class MovieDetailActivity extends BaseMVPActivity<MovieDetailContract
    ...
    private void initHeaderView(SubjectsBean subjectsBean) {
        ...
        Glide.with(this).asBitmap().load(subjectsBean.getImages().getLarge()).into(ivMoviePhoto);
