...
import newsapp.xtapp.com.staggeredpic.anim.MovingViewAnimator;
...
import newsapp.xtapp.com.staggeredpic.helper.BottomNavigationViewHelper;
import newsapp.xtapp.com.staggeredpic.model.bean.rxbus.RxEventHeadBean;
import newsapp.xtapp.com.staggeredpic.rxbus.RxBus;
import newsapp.xtapp.com.staggeredpic.rxbus.Subscribe;
import newsapp.xtapp.com.staggeredpic.util.FileUtils;
import newsapp.xtapp.com.staggeredpic.util.NavigationUtils;
...
import newsapp.xtapp.com.staggeredpic.view.QRCodeActivity;
import newsapp.xtapp.com.staggeredpic.view.about.AboutActivity;
import newsapp.xtapp.com.staggeredpic.view.book.BookRootFragment;
import newsapp.xtapp.com.staggeredpic.view.detail.WebViewLoadActivity;
import newsapp.xtapp.com.staggeredpic.view.gankio.GankIoRootFragment;
import newsapp.xtapp.com.staggeredpic.view.movie.MovieRootFragment;
import newsapp.xtapp.com.staggeredpic.view.personal.PersonalRootFragment;
import newsapp.xtapp.com.staggeredpic.view.widgets.MovingImageView;

import static newsapp.xtapp.com.staggeredpic.constant.HeadConstant.HEAD_IMAGE_NAME;
import static newsapp.xtapp.com.staggeredpic.constant.RxBusCode.RX_BUS_CODE_HEAD_IMAGE_URI;
...
public class MainActivity extends BaseActivity implements HomeFragment
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        if (headUri != null) {
            String cropImagePath = FileUtils.getRealFilePathFromUri(AppApplicationUtil.getContext(), headUri);
...
//        nvMenu.getMenu().findItem(R.id.item_model).setTitle(SPUtil.getNightModel(mContext) ?
//                "夜间模式" : "日间模式");
    ...
    public void rxBusEvent(RxEventHeadBean bean) {
        ...
        String cropImagePath = FileUtils.getRealFilePathFromUri(AppApplicationUtil.getContext(), uri);
        Bitmap bitMap = BitmapFactory.decodeFile(cropImagePath);
        if (bitMap != null)
            civHead.setImageBitmap(bitMap);
    }
