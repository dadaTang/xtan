...
import newsapp.xtapp.com.staggeredpic.presenter.book.BookDetailPresenter;
...
import static newsapp.xtapp.com.staggeredpic.constant.InternKeyConstant.INTENT_KEY_BOOK_BOOK_ITEM_BEAN;
...
public class BookDetailActivity extends BaseMVPActivity<BookDeatilContract
    ...
    private void initHeaderView(BookItemBean bookItemBean) {
        ...
        Glide.with(this).asBitmap().load(bookItemBean.getImages().getLarge()).into(ivBookPhoto);
